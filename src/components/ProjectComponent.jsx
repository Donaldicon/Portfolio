...
const ProjectComponent = () => {
  return (
    <div className='transition-all duration-500 dark:bg-[#171717] ease-in-out bg-[#f0f0f0] px-[4%] big:px-[15%] py-3 md:py-5 laptop:py-8 big:py-10 shadow-xl overflow-hidden hidden md:block font-jetBrainsMono  mt-[62px] laptop:mt-[100px] big:mt-[150px]'>
        <h1 className='bg-[#0a0707] text-[#CFCFD0] text-center py-3 font-bold text-[30px] lg:text-[35px] laptop:text-[45px] big:text-[60px] font-ibmMono rounded-lg'>Projects</h1>
        
        <div className='flex flex-col justify-center items-center '>
            <div className='bg-[#A3A3A3] dark:border-[#656566] dark:border-[2px] dark:bg-[#1e1e1e] px-3 laptop:py-2 big:py-3 py-1 w-[200px] laptop:w-[280px] big:w-[360px] text-center rounded-md laptop:rounded-lg shadow-md transition-all duration-500 ease-in-out mt-10'>
                <span className='font-jetBrainsMono font-semibold italic text-[13px] laptop:text-[18px] big:text-[25px] text-white dark:text-[#5E5E5E] transition-all ease-in-out duration-500 whitespace-nowrap'>
                    <FeaturedTyping />
                </span>
            </div>
            ...
            >
            <h1 className='text-center text-[40px] leading-[45px] laptop:text-[55px] laptop:leading-[80px] big:text-[90px] big:leading-[100px] mt-3 font-bold font-ibmMono dark:text-[#F0F0F0] transition-all ease-in-out duration-500'>Things I’ve Built on the Web</h1>

            <p className='text-center text-[#656566] dark:text-[#848485] text-[13px] laptop:text-[18px] big:text-[28px] mt-3 laptop:mt-4 big:mt-6 font-jetBrainsMono transition-all ease-in-out duration-500'>A glimpse into the web projects I’ve developed clean, fast,  <br />and built with care.</p>
            </motion.div>

            <div>
                {/* row 1 */}
                <div className='flex items-center justify-center space-x-5 laptop:space-x-6 big:space-x-10 px-[1.3%] mt-7 laptop:mt-9 big:mt-12 '>
                    {/* Ethereal */}
                    <div className='w-1/2'>
                    <motion.div
                ...
                {/* row 2 */}
                <div className='flex items-center justify-center space-x-5 laptop:space-x-6 big:space-x-10 px-[1.3%]  my-5 laptop:my-7 big:my-9'>
                    {/* Chess Corner */}
                    <div className='w-1/2'>
                        <motion.div
                            initial={{opacity:0, y:50}}
                ...
                {/* row 3 */}
                <div className='flex items-center justify-center space-x-5 laptop:space-x-6 big:space-x-10 px-[1.3%] overflow-hidden pb-10 laptop:my-7 big:my-9'>
                    {/* Rohze */}
                    <div className='w-1/2'>
                        <motion.div
                            initial={{opacity:0, y:50}}
            ...
            <div className='flex flex-row items-center  justify-between w-full mt-3 laptop:mt-5 big:mt-8'>
                ...
                <div className='flex flex-col'>
                    <h1 className='text-[40px] leading-[45px]  laptop:text-[55px] laptop:leading-[60px] big:text-[90px] big:leading-[100px] mt-3 font-bold font-ibmMono dark:text-[#F0F0F0] transition-all ease-in-out duration-500'>Have a Project <br /> In Mind</h1>
                    <p className=' text-[#656566] dark:text-[#848485] text-[13px] laptop:text-[18px] big:text-[28px] mt-3 laptop:mt-4 big:mt-6 font-jetBrainsMono transition-all ease-in-out duration-500'>I’m just a message away.</p>
                </div>
                </motion.div> 
                ...
                <motion.div
                initial={{opacity:0, x:50}}
                whileInView={{opacity:100, x:0}}                    transition={{duration:1, ease:easeInOut}}
                viewport={{once:true}}>
                <div>
            ...
            <div className='font-jetBrainsMono font-extrabold mt-5 text-[13px] laptop:text-[18px] big:text-[28px] italic transition-all ease-in-out duration-500 flex items-center space-x-6 laptop:space-x-8 big:space-x-10 text-[#656566] dark:text-[#656566]'>
